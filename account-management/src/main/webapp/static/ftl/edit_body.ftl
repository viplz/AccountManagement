    ...
    <#compress>
    	<div class="panel panel-default">
			...
			<div class="panel-body">
				<form id="editForm" class="form-horizontal" action="" role="form">
				  <div class="form-group">
				    <label for="name" class="col-xs-2 control-label">编码：</label>
				    <div class="col-xs-3">
				    	<input type="hidden" name="userId" value="${user.userId!''}"/>
				    	<input type="hidden" name="version" value="${user.version!''}"/>
				    	<input type="text" class="form-control" id="userCode" name="userCode" value="${user.userCode!''}" placeholder="请输入编码">
				    </div>
				  </div>
				  <div class="form-group">
				    <label for="name" class="col-xs-2 control-label">名称：</label>
				    <div class="col-xs-3">
				    	<input type="text" class="form-control" id="userName" name="userName" value="${user.userName!''}"  placeholder="请输入名称">
				    </div>
				  </div>
				  <div class="form-group">
